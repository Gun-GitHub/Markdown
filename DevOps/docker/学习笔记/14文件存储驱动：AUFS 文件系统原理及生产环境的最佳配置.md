...
![截图](images_14-aufs-storage/050b22bc74587335700cbedacd7c4bc9.png)
...
![截图](images_14-aufs-storage/0f06250668f8701b4f76a57e46748df8.png)

![截图](images_14-aufs-storage/a15d7c4a388a0f3648a73ce8beedeedc.png)

aufs 的工作过程中对文件的操作分为读取文件和修改文件

#### 读文件

![截图](images_14-aufs-storage/334a548783a4f5fb89bf52105fab37f9.png)

#### 写文件

![截图](images_14-aufs-storage/5d9628805d949ec294a6f97fb9fb02a3.png)
...
### 关联笔记
- [[学习笔记/15文件存储驱动：Devicemapper 文件系统原理及生产环境的最佳配置|15文件存储驱动：Devicemapper 文件系统原理及生产环境的最佳配置]]
