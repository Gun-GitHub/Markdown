...
| 测试节点 | 使用场景                                            | 测试用例               | 资源                                                         | 操作                                                         | 结果                                                         | 结论                   |
| -------- | --------------------------------------------------- | ---------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------------- |
| c3-gpu1  | ❗不使用 hami 单机单卡的场景                         | ollama run qwen3.5:35b | nvidia.com/gpu: '1'                                          | ✅ 不卸载 nvidia-device-plugin-daemonset<br/>❗不使用和部署 hami | ![image-20260326111718712](./images_英伟达gpu共享拆分/image-20260326111718712.png)<br />![image-20260326111742158](./images_英伟达gpu共享拆分/image-20260326111742158.png) | ✅ 能够正常使用单卡性能 |
| gpu1     | ✅使用 hami单机单卡                                  | ollama run qwen3.5:35b | nvidia.com/gpu: '1'                                          | ✅不卸载 nvidia-device-plugin-daemonset<br/>✅同时部署 hami<br/> | ![image-20260326115807206](./images_英伟达gpu共享拆分/image-20260326115807206.png?lastModify=1774497502)<br />![image-20260326115843049](./images_英伟达gpu共享拆分/image-20260326115843049.png) | ✅ 能够正常使用单卡性能 |
| gpu1     | ✅使用 hami单机单卡<br />✅详细设置所有资源上限的场景 | ollama run qwen3.5:35b | nvidia.com/gpu: 1<br />nvidia.com/gpumem: 5000<br/>nvidia.com/gpucores: 100 | ✅不卸载 nvidia-device-plugin-daemonset<br/>✅同时部署 hami<br/> | ![image-20260326134446054](./images_英伟达gpu共享拆分/image-20260326134446054.png)<br />![image-20260326134508386](./images_英伟达gpu共享拆分/image-20260326134508386.png) | ✅ 能够正常使用单卡性能 |
| gpu1     | ✅使用 hami单机单卡<br />⚠️关闭cuda劫持的场景         | ollama run qwen3.5:35b | nvidia.com/gpu: '1'                                          | ✅不卸载 nvidia-device-plugin-daemonset<br/>✅同时部署 hami<br/>⚠️给容器添加环境变量:CUDA_DISABLE_CONTROL=true | ![image-20260326111157402](./images_英伟达gpu共享拆分/image-20260326111157402.png)<br />![image-20260326111214602](./images_英伟达gpu共享拆分/image-20260326111214602.png) | ✅ 能够正常使用单卡性能 |
|          |                                                     |                        |                                                              |                                                              |                                                              |                        |
|          |                                                     |                        |                                                              |                                                              |                                                              |                        |
| gpu1     | ❗不使用 hami 单机多卡的场景                         | ollama run qwen3.5:35b | nvidia.com/gpu: 2                                            | ✅ 不卸载 nvidia-device-plugin-daemonset<br/>❗不使用和部署 hami | ![image-20260325180124738](./images_英伟达gpu共享拆分/image-20260325180124738.png)<br />![image-20260325180230093](./images_英伟达gpu共享拆分/image-20260325180230093.png) | ✅ 能够正常使用多卡性能 |
| gpu1     | ✅ 使用 hami单机多卡的场景                           | ollama run qwen3.5:35b | nvidia.com/gpu: 2<br />并设置了共享存储shm:10G               | ✅ 不卸载 nvidia-device-plugin-daemonset<br/>✅ 同时部署 hami  | ![image-20260325181914532](./images_英伟达gpu共享拆分/image-20260325181914532.png)<br />![image-20260325181944198](./images_英伟达gpu共享拆分/image-20260325181944198.png) | ❗无法正常使用多卡性能  |
| gpu1     | ✅使用 hami单机多卡<br />✅详细设置所有资源上限的场景 | ollama run qwen3.5:35b | nvidia.com/gpu: 2<br/>nvidia.com/gpumem: 10240<br/>nvidia.com/gpucores: 100<br />并设置了共享存储shm:10G | ✅ 不卸载 nvidia-device-plugin-daemonset<br/>✅ 同时部署 hami  | ![image-20260325181914532](./images_英伟达gpu共享拆分/image-20260325181914532.png)<br />![image-20260325181944198](./images_英伟达gpu共享拆分/image-20260325181944198.png) | ❗无法正常使用多卡性能  |
| gpu1     | ✅使用 hami单机多卡<br />⚠️关闭cuda劫持的场景         | ollama run qwen3.5:35b | nvidia.com/gpu: 2                                            | ✅不卸载 nvidia-device-plugin-daemonset<br/>✅同时部署 hami<br />⚠️给容器添加环境变量:CUDA_DISABLE_CONTROL=true | ![image-20260326103939228](./images_英伟达gpu共享拆分/image-20260326103939228.png)<br />![image-20260326103954357](./images_英伟达gpu共享拆分/image-20260326103954357.png) | ✅ 能够正常使用多卡性能 |
